 ...
 * 이 컨트롤러는 "/algoy/chatbot-demo" 경로로 들어오는 GET 요청을 처리하며,
...
public class ChatBotViewController {
   ...
   * 이 변수는 application.yml 파일에서 정의된 값을 주입받습니다.
   */
  @Value("${ai-backend.url}")
  private String backendUrl;

  /**
   * "/algoy/chatbot-demo" 경로에 대한 GET 요청을 처리하는 메서드입니다.
   * 이 메서드는 backendUrl 값을 모델에 추가하고, "temp/chatbot-demo" 뷰를
